...
public class MonthGroupsAdapter extends RecyclerView.Adapter<MonthGroupsAdapter.todayGroupsViewHolder> {
    private List<Groups> groupsList;

    public MonthGroupsAdapter(List<Groups> groupsList) {
        this.groupsList = groupsList;
    }

    @NonNull
    @Override
    public MonthGroupsAdapter.todayGroupsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MonthGroupsAdapter.todayGroupsViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_group_task, parent, false));
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull MonthGroupsAdapter.todayGroupsViewHolder holder, int position) {
...
//            firstCharacterTv.setText(groupsList.getId());
            ...
            cardView.setOnClickListener(v->{
                ...
                intent.putExtra("groupCategory","Month");
